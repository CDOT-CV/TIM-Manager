...
public class ValidateRsus implements Runnable {
    ...
    private void validateRsus() throws Exception {
        ...
        try {
            ...
            log.info("{}: " + "Unable to fetch all RSUs - will proceed with partial validation", this.getClass().getSimpleName());
    ...
    private void validateRsus(List<RsuValidationRecord> rsusToValidate) throws Exception {
        ...
        log.info("{}: " + "Validating {} RSUs...", this.getClass().getSimpleName(), tasks.size());
        ...
        try {
            ...
            log.info("{}: " + "Error while executing validation tasks:", this.getClass().getSimpleName());
    ...
    private List<ActiveTim> getActiveRsuTims() {
        ...
        try {
            ...
            log.info("{}: " + "Unable to validate RSUs - error occurred while fetching Database records from PROD:", this.getClass().getSimpleName());
            log.error("Exception", ex);
            return null;
        }
