...
public class UtilityController extends WydotTimBaseController {
    ...
    public UtilityController(BasicConfiguration _basicConfiguration, WydotTimService _wydotTimService,
            ...
            Utility _utility, TimGenerationHelper _timGenerationHelper, MilepostService _milepostService, IdenticalPointsExceptionHandler identicalPointsExceptionHandler, DateTimeHelper dateTimeHelper) {
