...
| CONFIG_ARC_GIS_URL            | CONTROLLER_CONFIG_ARC_GIS_URL            | config.arcGisUrl                          | Arc GIS URL for getting mileposts for CDOT  | https://dtdapps.codot.gov/server/rest/services/LRS/Routes_withDEC/MapServer/exts/LrsServerRounded |
...
| CONFIG_MILEPOST_PROVIDER      | MILEPOST_PROVIDER                        | config.milepostProvider                   | Milepost provider for DOT                   | GIS (CDOT) or neo4j (WyDOT)                                                                       |
